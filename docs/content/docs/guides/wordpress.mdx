...
<Tabs items={['Insert Headers & Footers Plugin', 'Add to functions.php', 'Modify header.php']}>
    <Tab>
    **Insert Headers and Footers Plugin**
    ...
    1. Install the Insert Headers and Footers plugin: [WordPress.org](https://wordpress.org/plugins/insert-headers-and-footers/) | [WordPress.com](https://wordpress.com/plugins/insert-headers-and-footers) (or a similar plugin that allows adding scripts to the header).
    ...
    3. Paste your Rybbit tracking snippet into the section designated for scripts in the header.
       ...
       ```
    4. Save your changes.
    5. **Note:** If the script doesn't work when placed in the header, try placing it in the body section instead. Some WordPress configurations may require the script to be loaded in the body for proper functionality.
    </Tab>
    <Tab>
